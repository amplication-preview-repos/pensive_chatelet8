...
class UserCreateInput {
  @ApiProperty({
    required: false,
    type: () => BodyMeasurementsCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => BodyMeasurementsCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => BodyMeasurementsCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PhotoUploadCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => PhotoUploadCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => PhotoUploadCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
